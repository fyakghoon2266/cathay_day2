...
- **客戶 agent**：10 位名人個性的客戶（巴菲特、川普、鄧崇儀等），由 Bedrock Claude 模型驅動
...
- **Per-customer 模型**：高難度客戶（Daniel/Trump/Elon）用 Sonnet 4.5，其他用 Haiku 4.5
...
| daniel | 鄧崇儀 | hard | Sonnet 4.5 | $3,000萬 |
...
5. 「去找客戶練習」→ 自主對話 → 看評分
6. 「幫我建一個給 Daniel 用的高爾夫 skill」→ 建 skill → 重啟 → 再試
7. 打開大廳看排行榜
